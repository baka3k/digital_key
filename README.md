# Disclaimer
This is an open-source sample created for educational and personal research purposes on Digital Key. 

All information, materials, and source code in this repository are collected from various sources and may not be entirely accurate or complete.

I am NOT responsible for any loss, damage, or violations resulting from the use of this source code. Users are solely responsible for ensuring compliance with legal regulations, terms of service, and related copyrights.

If you are a content owner or find any copyright infringement, please contact me so that I can review and adjust the content accordingly.

# Getting started
Here's the knowledge you need to know when starting a Digital-Key Project. It will help you approach the project more easily:
...
-   Sample Standard Transaction Flow
### Note:
...
The knowledge you need to know when starting a Digigal-Key Project, It will help you approach the project easier:
- Communication technology operating over a radio:
    -   NFC
    -   BLE
    -   UWB
...
1. Mobile(DigitalKeyModule) build TLV data then return to Vehicle follow structure
